...
平台总览页说明 SaveAny 支持哪些公开视频来源，以及哪些登录、付费、私密和 DRM 场景不会处理。

Canonical URL: https://saveany.local/platforms/
Last updated: 2026-04-30

## 页面定位
SaveAny支持平台包括 YouTube、Bilibili、抖音、TikTok、Instagram、Vimeo、Facebook、小红书和 Reddit 等公开视频来源。
...
## 主题导航
- [YouTube公开视频整理](https://saveany.local/platforms/youtube/): YouTube公开视频整理可用 SaveAny 完成：解析公开链接、选择 MP4、整理字幕、生成 AI 摘要、问答和 Markdown 学习笔记。
- [B站公开视频整理](https://saveany.local/platforms/bilibili/): B站公开视频整理可用 SaveAny 解析哔哩哔哩公开课程、合集和知识区视频，保存文件、整理字幕并生成 AI 复习笔记，适合课程学习和团队知识库沉淀。
- [抖音公开视频整理](https://saveany.local/platforms/douyin/): 抖音公开视频整理可用 SaveAny 保存可公开访问的抖音短视频，整理案例素材、字幕、AI 摘要和复盘笔记，适合内容运营、案例研究和知识类短视频归档。
- [TikTok公开视频整理](https://saveany.local/platforms/tiktok/): TikTok公开视频整理可用 SaveAny 解析公开短视频，保存可用格式、整理字幕，并生成 AI 摘要、问答和 Markdown 笔记流程。
